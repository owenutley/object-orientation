...
favoriteThings.car = "Formula1"
favoriteThings['show'] = ["The Cosby Show"]
...
function totalPopulation(obj1, obj2, obj3, obj4) {
...
function profileChange(name, email) {
  user.name = name
  user.email = email
}

profileChange("Bryan G. Smith", "bryan.smith@devmounta.in")
console.log(user)
//////////////////////////// PROBLEM 11 ////////////////////////////
/*
...
let cat1 = new Cat("Walter", 8, "Gray")
...
const harry = new Wizard("Harry", 14, "Expelliarmus")
harry.castSpell()
...
const phone1 = new Phone("Apple", "iPhone12", 256, "Red", 800)
const phone2 = new Phone("Samsung", "Note20", 256, "blue", 1200)
const phone3 = new Phone("Google", "Pixel", 256, "black", 724)
...
const myFirstVehicle = new Vehicle(5, "white", 56000)
...
const myFirstMotorcycle = new Motorcycle(1, "black", 27000, "Honda")
...
const myFirstBoat = new Boat(18, "white", 1800, "Andromeda", "Speed Boat")
